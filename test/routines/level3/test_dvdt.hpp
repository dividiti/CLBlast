...
#ifndef CLBLAST_TEST_ROUTINES_TEST_DVDT_H_
#define CLBLAST_TEST_ROUTINES_TEST_DVDT_H_
...
class TestDvdt {
 public:
  ...
  static StatusCode RunRoutine(const Arguments<T> &args, Buffers<T> &buffers, Queue &queue) {
    ...
    auto event = cl_event{};
    auto status = TestGemm(args.layout, args.a_transpose, args.b_transpose,
...
// CLBLAST_TEST_ROUTINES_TEST_DVDT_H_
#endif
